...
class Inventario:
    ...
    def guardar_inventario(self):
        ...
        try:
            with open(self.archivo_nombre, "w") as archivo:
                # Escribimos cada producto en una nueva línea con un formato simple (ID,nombre,cantidad,precio).
    ...
    def cargar_inventario(self):
        ...
        try:
            ...
            # Si el archivo no existe, lo creamos y continuamos.
            print("Archivo de inventario no encontrado. Se creará uno nuevo al guardar.")
            # Se crea un archivo vacío para evitar errores posteriores.
            with open(self.archivo_nombre, "w"):
                pass
        except IOError:
            print("Error: No se pudo leer el archivo. Revisa los permisos.")
        except Exception as e:
    ...
    def agregar_producto(self, producto):
        ...
        if any(p.get_id() == producto.get_id() for p in self.productos):
            ...
            return False
        self.productos.append(producto)
        # Después de añadir el producto, guardamos los cambios en el archivo.
    ...
    def eliminar_producto(self, producto_id):
        ...
        if len(self.productos) < productos_antes:
            ...
            # Después de la eliminación, guardamos los cambios.
            self.guardar_inventario()
            return True
        else:
    ...
    def actualizar_producto(self, producto_id, nueva_cantidad=None, nuevo_precio=None):
        ...
        for producto in self.productos:
            if producto.get_id() == producto_id:
                ...
                # Después de la actualización, guardamos los cambios.
                self.guardar_inventario()
                return True
        print("Error: No se encontró un producto con ese ID.")
        return False
